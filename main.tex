...
%CV: And what should be here? We need some assumptions. We may take out the next sentence, but it does clarify, as far as I can see?!?
...
% CV: maybe we should put this into the assumptions!
...
% CV: for mathematics, it has to be 0 and 1. 
...
where the term in the first square brackets corresponds to mutation towards the first allelic type from state $i-1$, that in the second to mutation to the second allelic type from state $i+1$, and that in the third to genetic drift.
